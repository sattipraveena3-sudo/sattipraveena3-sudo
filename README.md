...
| Clinical Trial Matching Engine | RAG, semantic search, structured eligibility filters | [Repository](https://github.com/sattipraveena3-sudo/clinical-trial-matching-engine) |
| Vital-Signs Anomaly Detector | State-space fusion, smoothing, physiological anomalies | [Repository](https://github.com/sattipraveena3-sudo/vitals-fusion-anomaly-detector) |
| Natural-Language-to-Infrastructure | Terraform generation, validation, LocalStack | [Repository](https://github.com/sattipraveena3-sudo/nl-to-infra-generator) |
| Repo-Aware Coding Assistant | AST indexing, call graphs, grounded code retrieval | [Repository](https://github.com/sattipraveena3-sudo/repo-aware-coding-assistant) |
| Hybrid Documentation Search | BM25, TF-IDF, reciprocal rank fusion | [Repository](https://github.com/sattipraveena3-sudo/hybrid-wiki-search-engine) |
| Transaction Graph Fraud Detector | Graph features, Isolation Forest, Neo4j | [Repository](https://github.com/sattipraveena3-sudo/transaction-graph-fraud-detector) |
| Distributed ML Task Queue | Redis workers, metrics, scaling policy | [Repository](https://github.com/sattipraveena3-sudo/distributed-ml-task-queue) |
| ETL Observability Dashboard | Data quality, schema drift, operational metrics | [Repository](https://github.com/sattipraveena3-sudo/etl-observability-dashboard) |
| HireLens | Applied language AI, ATS analysis | [Source](https://github.com/sattipraveena3-sudo/hirenlens-ats-scanner) |

My complete project portfolio is available at [sattipraveena3-sudo.github.io/projects.html](https://sattipraveena3-sudo.github.io/projects.html).
